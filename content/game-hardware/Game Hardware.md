...
A similar category is [[Gaming Platforms| Category 01]], which also uses the `index.md` method to specify a category page title and descriptive text.

## Related Categories

Game hardware works alongside [[Game Software|game software]] to provide the systems and programs needed to run and interact with games.